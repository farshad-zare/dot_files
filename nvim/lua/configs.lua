...
-- ------------------------------------------------------------------------------------------------------------------------
vim.cmd [[
    highlight! DiagnosticLineNrError guifg=#f70202 gui=bold
    highlight! DiagnosticLineNrWarn guifg=#f59842 gui=bold
    highlight! DiagnosticLineNrHint guifg=#42f545 gui=bold
    highlight! DiagnosticLineNrInfo guifg=#4290f5 gui=bold
...
-- ----------------- Use nvim-notify for plugins notifications ------------------------------------------------------------
-- ------------------------------------------------------------------------------------------------------------------------
